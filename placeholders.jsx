// Ilustrações SVG elegantes para os produtos.

function Placeholder({ kind, label, style = {} }) {
  const map = {
...
function EarringsPearl() {
  return (
    <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet" style={svgFull}>
      ...
      <g transform="translate(60 70)"><PearlCluster /></g>
      <g transform="translate(140 110)"><PearlCluster /></g>
    </svg>
  );
}
function PearlCluster() {
  const pearls = [[0,0],[14,0],[-14,0],[7,-12],[-7,-12],[7,12],[-7,12]];
  return (
    <g>
      {pearls.map(([x,y],i) => <circle key={i} cx={x} cy={y} r="7" fill="#FBF6EC" stroke="#D4B89C" strokeWidth="0.5"/>)}
      {pearls.map(([x,y],i) => <circle key={'h'+i} cx={x-2} cy={y-2} r="2" fill="#FFFEF9" opacity="0.8"/>)}
    ...
    <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet" style={svgFull}>
      ...
      <g transform="translate(100 100)" fill="none" stroke="#B8915A" strokeWidth="2.4">
        {Array.from({ length: 12 }).map((_, i) => {
          ...
          return <ellipse key={i} cx={x} cy={y} rx="8" ry="5" transform={`rotate(${rot} ${x} ${y})`}/>;
        })}
      </g>
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet" style={svgFull}>
      ...
      <g transform="translate(100 100)">
        ...
        <path d="M -40 -40 Q -40 -50 -28 -50 L 28 -50 Q 40 -50 40 -40 L 40 60 Q 40 68 32 68 L -32 68 Q -40 68 -40 60 Z" fill={accent}/>
        <path d="M -34 -38 Q -34 -46 -26 -46 L -22 -46 L -22 60 Q -22 64 -28 64 L -32 64 Q -34 60 -34 56 Z" fill="rgba(255,255,255,0.18)"/>
        <rect x="-26" y="-10" width="52" height="36" fill="rgba(255,255,255,0.85)" rx="1"/>
        <text x="0" y="8" textAnchor="middle" fontFamily="'Instrument Serif', serif" fontSize="11" fill={accent} fontStyle="italic">{label}</text>
        <text x="0" y="20" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="5" fill={accent} letterSpacing="2">EAU DE PARFUM</text>
      </g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet" style={svgFull}>
      ...
      <g transform="translate(100 110)">
        ...
        <path d="M -50 -10 Q -50 -50 0 -50 Q 50 -50 50 -10" fill="none" stroke={handle} strokeWidth="4"/>
  ...
  return (
    <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet" style={svgFull}>
      ...
      <g transform="translate(100 100)">
        ...
        <path d="M -54 0 Q -64 -24 -50 -32" fill="none" stroke="#D4A574" strokeWidth="1.2" strokeDasharray="2 2"/>
        <path d="M 54 0 Q 64 -24 50 -32" fill="none" stroke="#D4A574" strokeWidth="1.2" strokeDasharray="2 2"/>
      </g>
    </svg>
  );
    ...
    <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet" style={svgFull}>
      ...
      <g transform={`translate(100 ${tall ? 108 : 116})`}>
        ...
        <g transform={`translate(0 ${-h/2-14})`}>
          ...
          <path d="M -2 4 L -10 22 L -4 18 L -6 28 L 0 18 L 6 28 L 4 18 L 10 22 L 2 4 Z" fill={ribbon}/>
        </g>
      </g>
    </svg>
  );
  ...
  return (
    <>
      ...
      {Array.from({ length: 24 }).map((_, i) => (
        <circle key={i} cx={(i*37)%200} cy={(i*53)%200} r="0.5" fill="rgba(34,21,18,0.08)"/>
      ))}
    </>
  );
}
