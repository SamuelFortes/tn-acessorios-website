    ...
    <div className="page-enter">
        ...
        <div className="container" style={{
          ...
          <div>
            ...
            <p style={{
              ...
              fontSize: 17, lineHeight: 1.55, color: 'var(--text-2)',
              maxWidth: 480,
            }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <button className="btn btn-primary btn-lg"
                onClick={() => onNavigate({ view: 'category', cat: 'kits' })}>
                Ver kits presenteáveis <Icon name="arrow" />
              </button>
              <button className="btn btn-ghost btn-lg"
                onClick={() => onNavigate({ view: 'category', cat: 'joias' })}>
                Explorar joias
              </button>
            </div>
            <div style={{
      ...
      <section className="container" style={{ padding: '120px 0 24px' }}>
        <div style={{
          ...
          display: 'grid', gridTemplateColumns: 'minmax(0, 1.3fr) minmax(0, 1fr)', gap: 56,
          alignItems: 'center',
        }}>
          <div>
            <p style={{ ...eyebrow, color: 'rgba(255,255,255,.6)', marginBottom: 16 }}>✦ Kits presenteáveis</p>
            <h2 className="font-display" style={{ fontSize: 'clamp(40px, 5vw, 68px)', margin: 0 }}>
              O presente <span className="font-display-italic">perfeito</span><br/>
              já vem montado.
            </h2>
          ...
          <div style={{
            ...
            fontSize: 320, fontStyle: 'italic',
            color: 'rgba(255,255,255,.05)', lineHeight: 0.8,
            pointerEvents: 'none',
          }}>TN</div>
        </div>
      </section>
      ...
      <section className="container" style={{ padding: '96px 0 24px' }}>
        <SectionHeader
          eyebrow="Brilho diário"
          title="Joias para todos os dias"
        />
        <div style={{
          display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 28,
          marginTop: 40,
      ...
      <section className="container" style={{ padding: '120px 0 60px' }}>
        <div style={{
          display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1.2fr)', gap: 80,
          alignItems: 'center',
        }}>
          <div style={{ position: 'relative', aspectRatio: '4/5', overflow: 'hidden' }}>
            <div style={{
              position: 'absolute', inset: 0,
              background: 'linear-gradient(135deg, #C9876F, #6B1E2C)',
            }} />
            <div style={{
              position: 'absolute', inset: 0,
              display: 'grid', placeItems: 'center',
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{
                  ...
                  marginTop: 18, lineHeight: 1.1,
                }}>“Para mulheres reais.”</div>
          ...
          <div>
            ...
            <h2 className="font-display" style={{ fontSize: 'clamp(40px, 4.5vw, 64px)', margin: 0 }}>
              Começou em casa,<br/>
              <span className="font-display-italic" style={{ color: 'var(--accent)' }}>chegou em vocês</span>.
            </h2>
      ...
      <section className="container" style={{ padding: '40px 0 60px' }}>
        ...
        <div style={{
          display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 24, marginTop: 40,
        }}>
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'end', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
      <div>
        ...
        <h2 className="font-display" style={{ fontSize: 'clamp(36px, 4vw, 52px)', margin: 0 }}>
          {title}
        </h2>
      </div>
      {right}
  ...
  return (
    <div className="page-enter">
          ...
          <div style={{ display: 'flex', gap: 4 }}>
            {[3, 4].map(n => (
              <button key={n} onClick={() => setLayout(n)}
                ...
                style={{
                  width: 32, height: 32,
                  background: n === layout ? 'var(--bg-2)' : 'transparent',
                }}>
      ...
      <section className="container" style={{ padding: '48px 0 60px' }}>
        <div style={{
          display: 'grid', gridTemplateColumns: `repeat(${layout}, minmax(0, 1fr))`, gap: 28,
        }}>
          {sorted.map(p => (
            <ProductCard key={p.id} product={p}
              onClick={() => onNavigate({ view: 'product', id: p.id })}
  ...
  return (
    <div className="page-enter">
      ...
      <section className="container" style={{
        ...
        <div>
          <div style={{
            aspectRatio: '4/5', background: 'var(--surface)', overflow: 'hidden',
            border: '1px solid var(--line)',
          }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <h1 className="font-display" style={{ fontSize: 'clamp(40px, 4.5vw, 64px)', margin: 0 }}>
            {p.name}
          </h1>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginTop: 18 }}>
            <span className="font-display-italic tabular" style={{ fontSize: 42, color: 'var(--accent)' }}>
              {formatBRL(p.price)}
            </span>
            {p.oldPrice && (
              <span className="tabular" style={{ fontSize: 16, textDecoration: 'line-through', color: 'var(--muted)' }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.65, color: 'var(--text-2)', marginTop: 28 }}>
            {p.desc}
          </p>
          ...
          <div style={{
            ...
            marginTop: 32, padding: '20px 0', borderTop: '1px solid var(--line)', borderBottom: '1px solid var(--line)',
          }}>
            {[
              { i: 'gift', t: 'Embalagem inclusa' },
      ...
      <section className="container" style={{ padding: '60px 0' }}>
        ...
        <div style={{
          display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 28, marginTop: 32,
        }}>
          {related.map(r => (
  ...
  return (
    <div className="page-enter">
      ...
      <section className="container" style={{ padding: '40px 0 60px' }}>
        ...
        <div style={{ marginTop: 28, display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 0, borderTop: '1px solid var(--line-2)' }}>
          {[
