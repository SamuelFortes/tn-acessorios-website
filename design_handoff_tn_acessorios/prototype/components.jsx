// Shared components: Header, Footer, ProductCard, Icons, Cart drawer, etc.
...
// ── Header ────────────────────────────────────────────────────────────────
function Header({ nav, route, onNavigate, cartCount, onOpenCart, onOpenSearch }) {
  return (
    <header style={{
      ...
      <div className="container" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <button className="icon-btn hide-mobile" onClick={onOpenSearch} aria-label="Buscar"><Icon name="search" /></button>
    ...
    <footer style={{
      ...
      <div className="container" style={{ padding: '64px 0 28px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, fontSize: 12, color: 'var(--text-2)' }}>
          <span>© 2026 TN Acessórios · CNPJ ilustrativo · Teresina, PI</span>
...
const colTitle = {
  ...
  fontWeight: 600, marginBottom: 18, color: 'var(--text)',
};
...
// ── Product Card ─────────────────────────────────────────────────────────
function ProductCard({ product, onClick, onAdd, layout = 'grid' }) {
        ...
        {cart.length > 0 && (
          <div style={{ padding: 28, borderTop: '1px solid var(--line)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 18, fontSize: 13, color: 'var(--text-2)' }}>
              <span>Frete</span>
              <span style={{ fontStyle: 'italic' }}>calculado no WhatsApp</span>
            </div>
